...
const PatientCard = ({ fullName, online, level, gender, age, detail }) => {
  const { deleteMyPatient } = useAppContext();

  return (
    <article className="rounded-xl bg-white shadow-lg">
